...
public class EditInvoiceDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_invoice_detail);
        ...
        if (extras != null){
            ...
            invoiceDetail = mInvoiceDetailViewModel.getInvoiceById(id);
            if (invoiceDetail != null){
                String productName = invoiceDetail.getProductName();
                productEditView.setText(productName);
                priceEditView.setText(Double.toString(invoiceDetail.getPricePerUnit()));
                quantityEditView.setText(Integer.toString(invoiceDetail.getQuantity()));
            }
        }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (TextUtils.isEmpty(productEditView.getText()) || TextUtils.isEmpty(quantityEditView.getText()) || TextUtils.isEmpty(priceEditView.getText())){
                    ...
                    Intent replyIntent = new Intent();
                    replyIntent.putExtra(EXTRA_REPLY_INVOICE_DETAIL_ID, invoiceDetail.getId());
